...
1. Follow the [Day 1](https://github.com/JeffersenGodfrey/100_Days_DevOps_Challenge/blob/main/Day%201/001.md) to connect server and run the following command:
