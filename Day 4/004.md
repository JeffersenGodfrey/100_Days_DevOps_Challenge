...
1. Connect to App server 1
   Login was performed from the jumphost using the preconfigured application server user:
...
2. Verify the Server 
    ...
    ```  
3. Check the current file permission status:
...
4. Run the following command to update permissions:
